...
class MovieDetailsSuccessStatePage extends StatelessWidget {
  const MovieDetailsSuccessStatePage({super.key, required this.state});

  final MovieDetailsSuccessState state;
