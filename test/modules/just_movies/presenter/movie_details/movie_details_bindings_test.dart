...
void main() {
  late MovieDetailsBindings movieDetailsBindings;
  ...
  setUp(() {
    ...
    movieDetailsBindings = MovieDetailsBindings(movieId: 1, title: 'teste');
    initialBindings.dependencies();
    homeBindings.dependencies();
  });

  tearDown(() {
    movieDetailsBindings.dispose();
    homeBindings.dispose();
    initialBindings.dispose();
  });

  group('MovieDetailsBindings | ', () {
    test('should register all dependencies - ', () {
      // arrange & act
      movieDetailsBindings.dependencies();
      // assert
      ...
      expect(GetIt.I.isRegistered<IGetMovieDetailsUsecase>(), isTrue);
      expect(GetIt.I.isRegistered<MovieDetailsController>(), isTrue);

      expect(GetIt.I<IGetMovieDetailsUsecase>(), isA<GetMovieDetailsUsecaseImpl>());
      expect(GetIt.I<MovieDetailsController>(), isA<MovieDetailsController>());
    });
  });
}
